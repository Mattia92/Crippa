...
function ready(){
    ...
    $.ajax({
        ...
        url: "http://frankgym.altervista.org/php/getCoursesAlpha.php", //Relative or absolute path to file.php file
        data: {course:id},
    ...
    $(this).wrapInner('<a href="http://frankgym.altervista.org/course.html?idCourse='+courses[i].id+'">'+courses[i].title+"<br>"+'</a>')});
    ...
    $(this).wrapInner('<a href="http://frankgym.altervista.org/course.html?idCourse='+courses[j].id+'">'+courses[j].title+"<br>"+'</a>')});
                count++;
                }
               }
