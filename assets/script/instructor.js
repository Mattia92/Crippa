...
function evan(){
    ...
    $.ajax({
        ...
        url: "http://frankgym.altervista.org/php/getInstructor.php", //Relative or absolute path to file.php file
        data: {instructor:id},
        success: function(response) {
           ...
           $('.description').eq(0).text(instructor[myParam-1].Presentation);
...
function asder(){
    ...
    $.ajax({
        ...
        //dataType: "json", //type of data
        crossDomain: true, //localhost purposes
        url: "http://frankgym.altervista.org/php/getTeach.php", //Relative or absolute path to file.php file
        data: {instructor:id},
        success: function(response) {
        console.log("VAI");
    ...
    $(this).wrapInner('<a href="http://frankgym.altervista.org/course.html?idCourse='+teach[i].idCourse+'">'+tit+'<br><br>'+'</a>');
});
